...
[[Alex (Bumpkin)|Alex]] and one of the cart members investigate the book. The cart member thinks of something and exits the cabin. Alex levitates them in the air, where they are promptly snatched away by the creatures.

The group becomes more and more sickly as time goes by, enduring an unknown status effect. As [[Clobo the Globo (Clown Goblin)|Clobo]] and [[Hesinx (Blind Aristocrat)|Hesinx]] decipher the code, the suffer the final stack and turn into miniature versions of the outside creatures. 

The group makes one more run for it, back to the road. They find out that the creatures cannot leave the wheat fields. After time passes, it returns back to day, and they return back to Giskenroc. 

[[Alex (Bumpkin)|Alex]] levels up.